  ...
  <?php endif; ?>
	<div class="form-row place-order">
		<noscript>
			...
			?>
			<br/><button type="submit" class="button alt order-received__continue-btn" name="woocommerce_checkout_update_totals" value="<?php esc_attr_e( 'Update totals', 'woocommerce' ); ?>"><?php esc_html_e( 'Update totals', 'woocommerce' ); ?></button>
		</noscript>
