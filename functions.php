...
if ( ! function_exists( 'mst_bodleid_setup' ) ) :
	...
	function mst_bodleid_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'mst_bodleid' ),
		) );
...
function mst_bodleid_scripts() {
	...
	wp_enqueue_script( 'mst_bodleid-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'mst_bodleid-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
