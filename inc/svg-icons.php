...
if ( ! function_exists( 'mst_bodleid_the_theme_svg' ) ) {
   ...
   */
  function mst_bodleid_the_theme_svg( $svg_name, $group = 'ui', $color = '' ) {
    echo mst_bodleid_get_theme_svg( $svg_name, $group, $color );
  }
}
...
if ( ! function_exists( 'mst_bodleid_get_theme_svg' ) ) {
   ...
   * @return string|bool
   */
  function mst_bodleid_get_theme_svg( $svg_name, $group = 'ui', $color = '' ) {
